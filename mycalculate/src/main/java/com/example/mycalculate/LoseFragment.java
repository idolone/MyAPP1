...
import com.example.mycalculate.databinding.FragmentLoseBinding;
import com.example.mycalculate.databinding.FragmentWinBinding;
...
public class LoseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myViewModel = new ViewModelProvider(getActivity(),new SavedStateViewModelFactory(getActivity().getApplication(),getActivity())).get(MyViewModel.class);
